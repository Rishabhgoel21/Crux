...
public class doubts {
	...
	public static void Schlrship(int n, int m, int x, int y) {
		...
		// n = no. of students, m = no. of coupons
		// x = student will get 100% waiver if he gets X coupons
		// y = who perform badly in the admission tests, need to pay additional amount
		// equivalent to Y discount coupons, i.e. good students earn discount coupons
